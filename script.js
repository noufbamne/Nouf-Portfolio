...
document.getElementById("contactForm").addEventListener("submit", async (e) => {
    ...
    try {
        ...
        if (data.success) {
            ...
            // show toast (SUCCESS UI)
            toast.innerHTML = `
                ✔ Email sent successfully!<br>
                <small>Thank you for contacting. We will respond soon.</small>
            `;
            ...
            toast.innerHTML = `❌ Failed to send message`;
            toast.classList.add("show");
        ...
        toast.innerHTML = `⚠ Server error. Try again later.`;
        toast.classList.add("show");
...
//                 if (!successBox) {
//             console.error("successBox NOT FOUND in HTML");
//             return;
//         }

//         // LOCK UI STATE (prevents double clicks / glitches)
//         submitBtn.disabled = true;
//         submitBtn.innerHTML = "✔ Email Sent";
//         submitBtn.style.background = "#00c853";

//         // smooth transition instead of instant hide/show
...
//             submitBtn.style.background = "#d50000";
...
//         submitBtn.innerHTML = "Server Error ❌";
//         submitBtn.style.background = "#d50000";
...
//         Thank you for contacting. We will respond soon.
//         </span>
//     </div>
//     `;
...
//         message: document.getElementById("message").value
//     };
//     emailjs.send("service_z973cnl","template_rfzunt2",parms).then(function(res){
